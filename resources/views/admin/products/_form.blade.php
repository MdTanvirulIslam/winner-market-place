...
<div>
    ...
    <p class="mt-1 text-[12px] text-muted">JPG, PNG, or WebP — up to 10 images, 4 MB each. Any size works: images are automatically fitted to 1280×720 (16:9) — wide or tall images get a soft blurred background.</p>
